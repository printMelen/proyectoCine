<aside class="flex flex-col items-center w-[300px] h-screen bg-back">
     <a href="index.php?peticion=landingAdmin">
          ...
          <nav class="text-white">
               <ul class="w-[200px]">
                    ...
                    <li><a href="index.php?peticion=formularioActor" class="flex items-center gap-[10px] pb-[20px]"><img src="app/view/images/MingcuteUserAdd2Fill.svg" class="w-[30px]" alt="" srcset="">Añadir Director/actor/actriz</a></li>
