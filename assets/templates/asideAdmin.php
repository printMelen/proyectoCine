<aside class="flex flex-col items-center w-[300px] h-[800px] bg-back">
          <img src="../images/playOn.svg" class="w-[200px] py-[15px]" alt="" srcset="">
          <nav class="text-white">
               <ul class="w-[200px]">
                    ...
                    <li><a href="#" class="flex items-center gap-[10px] pb-[20px]"><img src="../images/MingcuteUserAdd2Fill.svg" class="w-[30px]" alt="" srcset="">Añadir usuario</a></li>
