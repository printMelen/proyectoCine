    ...
    <div class="h-[516px] w-[500px] mx-auto bg-login backdrop-blur-[10px] rounded-[15px] flex flex-col justify-center">
            ...
            <div class="w-[300px] mx-auto text-white ">
                ...
                <form action="index.php?peticion=login" method="post">
                    <input type="email" placeholder="Email" name="" id="" class="w-[100%] mb-[27px] h-[50px] rounded-[10px] bg-backInputs pl-[21px] backdrop-blur-[10px]">
                    <input type="submit" value="Recuperar" class="bg-pink backdrop-blur-[10px] w-[100%] h-[50px] font-600 text-22 rounded-[10px]">
                </form>
            </div>
</div>
</body>
